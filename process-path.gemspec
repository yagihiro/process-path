...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Process::Path is a small library to get the path of the currently running process.}
  spec.description   = %q{Process::Path is a small library to get the path of the currently running process.}
